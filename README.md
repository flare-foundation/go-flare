...
go-flare is a modified version of [avalanchego@v1.13.0](https://github.com/ava-labs/avalanchego/releases/tag/v1.13.0) and [coreth@v0.15.0 rc0](https://github.com/ava-labs/coreth/releases/tag/v0.15.0-rc.0), incorporating specific features for Flare and Songbird networks. These features include prioritized contract handling and the invocation of the daemon contract.
