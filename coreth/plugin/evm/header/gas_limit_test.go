...
func TestGasLimit(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			upgrades: params.TestFlareFortunaChainConfig.NetworkUpgrades,
			parent: &types.Header{
				Number: big.NewInt(1),
			},
		...
		{
			name:     "cortina",
			upgrades: params.TestFlareCortinaChainConfig.NetworkUpgrades,
			want:     cortina.GasLimit,
		},
		{
			name:     "ap1",
			upgrades: params.TestFlareApricotPhase1Config.NetworkUpgrades,
			want:     ap1.GasLimit,
		},
		{
			name:     "launch",
			upgrades: params.TestFlareLaunchConfig.NetworkUpgrades,
			parent: &types.Header{
				GasLimit: 1,
			},
